...
To run a single test inside a specific Python environment, do e.g.::
    ...
    tox -e py36 tests/test_validation.py:TestServiceDefinition.test_content_type_missing

or::

    tox -e py36 tests.test_validation:TestServiceDefinition.test_content_type_missing
